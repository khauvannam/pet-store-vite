    ...
    <div class="max-w-[1440px] mx-auto px-4">
      ...
      <article class="p-6 text-base bg-white rounded-lg dark:bg-gray-900">
          ...
          <div class="flex items-center">
            <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold">
              <img
                  ...
                  alt="user@example.com">youremail.gmail.com
            </p>
        ...
        <p class="text-gray-500 dark:text-gray-400">
          This is the content of the comment. It can be a paragraph or multiple lines of text.
        </p>
        <div class="flex items-center mt-4 space-x-4 justify-between">
          <button type="button"
                  class="flex items-center text-sm text-gray-500 hover:underline dark:text-gray-400 font-medium">
            <svg class="mr-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"
      ...
      <!-- Repeat above comment block as needed -->
      <!-- Example of a comment -->
      <article class="p-6 text-base bg-white rounded-lg dark:bg-gray-900">
        <footer class="flex justify-between items-center mb-2">
          <div class="flex items-center">
