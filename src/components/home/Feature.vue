...
<template>
  <div class="py-10 w-full flex justify-center items-center md:py-14">
    <div class="w-full max-w-[1440px] flex-col flex items-center">
      <h3 class="pb-6 text-center">
        ...
        <p class="text-main pt-6 max-w-[800px]">
          Be the first to know about our latest offers and save on your pet's favorite products. Join us today and make
          your pet's well-being our priority. Sign up now and never miss out on the best for your best friend!
        </p>
      </h3>
      <div class="pt-10 w-full">
        <div
            class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 md:gap-10 px-6 sm:px-8 md:px-10 text-main text-center">
          <div class="flex flex-col items-center ">
            <div class="pb-5">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" fill="rgba(0,32,92,1)">
                <path
                    d="M2.99805 21V19H4.99805V4C4.99805 3.44772 5.44576 3 5.99805 3H17.998C18.5503 3 18.998 3.44772 18.998 4V19H20.998V21H2.99805ZM16.998 5H6.99805V19H16.998V5ZM14.998 11V13H12.998V11H14.998Z"></path>
              </svg>
            </div>
        ...
        <div class="pt-10 flex justify-center w-full max-w-[335px] mx-auto">
          <div class="w-full">
            <custom-button :value="'Shop All'"/>
          </div>
        </div>
      </div>
    </div>
